...
class Pokeballs implements Feature {
    ...
    defaults = {
        ...
        pokemonTypeSelection: GameConstants.Pokeball.None,
    };
    ...
    private _pokemonTypeSelection: KnockoutObservable<GameConstants.Pokeball>;
    ...
    constructor() {
        ...
        this._pokemonTypeSelection = ko.observable(this.defaults.pokemonTypeSelection);
    ...
    public calculatePokeballToUse(enemyPokemon: BattlePokemon, isShiny: boolean): GameConstants.Pokeball {
        ...
        let pref1: GameConstants.Pokeball;
        let pref2: GameConstants.Pokeball;
        ...
        if (enemyPokemon.type1 == PokemonType.Flying || enemyPokemon.type2 == PokemonType.Flying) {
            pref = Math.max(pref, this.pokemonTypeSelection);
        }
    ...
    fromJSON(json: Record<string, any>): void {
        ...
        this.pokemonTypeSelection = json['pokemonTypeSelection'] ?? this.defaults.pokemonTypeSelection;
    }
    ...
    toJSON(): Record<string, any> {
        return {
            ...
            'pokemonTypeSelection': this.pokemonTypeSelection,
        };
    }
    ...
    get pokemonTypeSelection() {
        return this._pokemonTypeSelection();
    }

    set pokemonTypeSelection(ball: GameConstants.Pokeball) {
        this._pokemonTypeSelection(ball);
    }
}
